...
from core.wallet.tx.sighash import plan_sighash_all


def test_plan_sighash_all_is_deterministic() -> None:
    ...
    h1 = plan_sighash_all(unsigned, 0, pubkey)
    h2 = plan_sighash_all(unsigned, 0, pubkey)
